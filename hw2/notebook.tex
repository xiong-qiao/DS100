...
{\color{incolor}In [{\color{incolor}16}]:} \PY{n}{q2b} \PY{o}{=} \PY{l+s+sa}{r}\PY{l+s+s2}{\PYZdq{}\PYZdq{}\PYZdq{}}
         ...
         \PY{l+s+s2}{The casual density curve has more modes with smaller rider count and is right skewed, the main rider count }
         \PY{l+s+s2}{lies in between 200 \PYZhy{} 1600. However, the registered density curve is symmetry with the median at around 4000 }
         \PY{l+s+s2}{and is kind like a Gaussian distribution.}
...
The casual density curve has more modes with smaller rider count and is right skewed, the main rider count 
lies in between 200 - 1600. However, the registered density curve is symmetry with the median at around 4000 
and is kind like a Gaussian distribution.
...
{\color{incolor}In [{\color{incolor}19}]:} \PY{n}{q2d} \PY{o}{=} \PY{l+s+sa}{r}\PY{l+s+s2}{\PYZdq{}\PYZdq{}\PYZdq{}}
         ...
         \PY{l+s+s2}{For both working and non\PYZhy{}working days, there is a positive correlation between causal and registered people. }
         \PY{l+s+s2}{For working days, the correaltion is stronger, and weaker for non\PYZhy{}working days.}
...
For both working and non-working days, there is a positive correlation between causal and registered people. 
For working days, the correaltion is stronger, and weaker for non-working days.
...
{\color{incolor}In [{\color{incolor}22}]:} \PY{n}{q3b} \PY{o}{=} \PY{l+s+sa}{r}\PY{l+s+s2}{\PYZdq{}\PYZdq{}\PYZdq{}}
         ...
         \PY{l+s+s2}{slightly weeker positive correlation for non\PYZhy{}work days.}
         ...
         \PY{l+s+s2}{regression line which directly shows us the relation between the 2 variables. But in the countour plot, we}
         \PY{l+s+s2}{need to figure it out harder by ourselves.}
...
slightly weeker positive correlation for non-work days.

I think it's easy to see the relationship on the plot created for 2c, because on plot 2c, there is a linear 
regression line which directly shows us the relation between the 2 variables. But in the countour plot, we
need to figure it out harder by ourselves.
...
{\color{incolor}In [{\color{incolor}26}]:} \PY{n}{q4b} \PY{o}{=} \PY{l+s+sa}{r}\PY{l+s+s2}{\PYZdq{}\PYZdq{}\PYZdq{}}
         ...
         \PY{l+s+s2}{riders are less than that of registered riders. }
...
riders are less than that of registered riders. 
...
{\color{incolor}In [{\color{incolor}29}]:} \PY{n}{q5b} \PY{o}{=} \PY{l+s+sa}{r}\PY{l+s+s2}{\PYZdq{}\PYZdq{}\PYZdq{}}
         ...
         \PY{l+s+s2}{The registerd riders have a bigger variance with 2 peaks, while the causal riders vary less. We can observe }
         \PY{l+s+s2}{that the 2 peaks}\PY{l+s+s2}{\PYZsq{}}\PY{l+s+s2}{ corresponding time are around 8 and 17, which just coincides with the commute time. So we }
         \PY{l+s+s2}{may safely assume that it}\PY{l+s+s2}{\PYZsq{}}\PY{l+s+s2}{s because some people tend to use bikes to go to work and go back home.}
...
The registerd riders have a bigger variance with 2 peaks, while the causal riders vary less. We can observe 
that the 2 peaks' corresponding time are around 8 and 17, which just coincides with the commute time. So we 
may safely assume that it's because some people tend to use bikes to go to work and go back home.
...
{\color{incolor}In [{\color{incolor}38}]:} \PY{n}{q6c} \PY{o}{=} \PY{l+s+sa}{r}\PY{l+s+s2}{\PYZdq{}\PYZdq{}\PYZdq{}}
         ...
         \PY{l+s+s2}{Generally speaking, the casual rider proportion has a positive correlation with temperature. That means the }
         \PY{l+s+s2}{casual rider proportion goes up with temperature going up. }
...
Generally speaking, the casual rider proportion has a positive correlation with temperature. That means the 
casual rider proportion goes up with temperature going up. 
